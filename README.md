...
| AI 聊天 | 知识库 |
| --- | --- |
| ![AI 聊天](docs/images/chat.png) | ![知识库](docs/images/knowledge.png) |

| 题库 / 错题集 | 首页概览 |
| --- | --- |
| ![题库](docs/images/quiz.png) | ![概览](docs/images/overview.png) |
...
- **回答校验门**(可选):交付前对格式 / 知识库 grounding / 代码可运行 / LLM 自评打分做校验,不过则自动带反馈重答。
