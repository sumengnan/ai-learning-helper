...
export const SUGGESTIONS: Suggestion[] = [
  ...
  { text: "随机生成 10 道 AI 相关的单选题，保存到题库", icon: <QuizIcon />, color: "#7c3aed" },
  { text: "从题库抽取 10 道题考试", icon: <SchoolIcon />, color: "#d97706" },
  ...
  { text: "根据我的错题，针对性地再出 10 道相似的题", icon: <AutorenewIcon />, color: "#4f46e5" },
];
